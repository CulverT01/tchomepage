...
<div class="container fluid">
  ...
  <div class="row justify-content-center">
    ...
    Below are the Drivers' Championship standings:<br/>
    <img src="afepf1_drivers_p1-9.png" alt="Screenshot of the first 9 positions of the Drivers' Championship, outputted by afepf_viewer_program.py"><br/>
    <img src="afepf1_drivers_p10-18.png" alt="Screenshot of the positions 10 to 18 of the Drivers' Championship, outputted by afepf_viewer_program.py"><br/>
    <img src="afepf1_drivers_p19-27.png" alt="Screenshot of the positions 19 to 27 of the Drivers' Championship, outputted by afepf_viewer_program.py"><br/>
    <img src="afepf1_drivers_p28-35.png" alt="Screenshot of the positions 28 to 35 of the Drivers' Championship, outputted by afepf_viewer_program.py"><br/>
    </p> 
    ...
    <img src="afepf1_teams_p1-6.png" alt="Screenshot of the first 6 positions of the Teams' Championship, outputted by afepf_viewer_program.py"><br/>
    <img src="afepf1_teams_p7-10.png" alt="Screenshot of the positions 7 to 10 of the Teams' Championship, outputted by afepf_viewer_program.py"><br/>
    </p>
  </div>
  <div class="row justify-content-center">
