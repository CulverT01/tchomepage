...
<div class="container fluid">
  ...
  <div class="row justify-content-center">
    ...
    <img src="afepf2_drivers_p1-9.png" alt="Screenshot of the first 9 positions of the Overall Drivers' Championship, outputted by afepf_viewer_program.py"><br/>
    <img src="afepf2_drivers_p10-18.png" alt="Screenshot of the positions 10 to 18 of the Overall Drivers' Championship, outputted by afepf_viewer_program.py"><br/>
    <img src="afepf2_drivers_p19-23.png" alt="Screenshot of the positions 19 to 23 of the Overall Drivers' Championship, outputted by afepf_viewer_program.py"><br/>
    </p>
    ...
    <img src="afepf2_customer_drivers_p1-9.png" alt="Screenshot of the Customer Trophy for Drivers standings, outputted by afepf_viewer_program.py">
    </p>
    ...
    <img src="afepf2_npjt_drivers_p1-7.png" alt="Screenshot of the Nelson Piquet Jr Trophy standings, outputted by afepf_viewer_program.py">
    </p>
    ...
    <img src="afepf2_teams_p1-9.png" alt="Screenshot of the Teams' Championship, outputted by afepf_viewer_program.py">
    </p>
    ...
    <img src="afepf2_customer_teams_p1-3.png" alt="Screenshot of the Customer Teams' Championship, outputted by afepf_viewer_program.py">
    </p>
    ...
    <img src="afepf2_manufacturers_p1-6.png" alt="Screenshot of the Manufacturers' Cup standings, outputted by afepf_viewer_program.py">
    </p>
  </div>
</div>