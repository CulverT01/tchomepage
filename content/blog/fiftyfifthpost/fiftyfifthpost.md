...
<div class="container fluid">
  ...
  <div class="row justify-content-center">
    ...
    {% "afepf4_drivers_p1-9.png", "Screenshot of the first 9 positions of the Overall Drivers' Championship, outputted by afepf_viewer_program.py" %}
    {% "afepf4_drivers_p10-18.png", "Screenshot of the positions 10 to 18 of the Overall Drivers' Championship, outputted by afepf_viewer_program.py" %}
    {% "afepf4_drivers_p19-25.png", "Screenshot of the positions 19 to 25 of the Overall Drivers' Championship, outputted by afepf_viewer_program.py" %}
    ...
    {% "afepf4_npjt_drivers_p1-9.png", "Screenshot of the first 9 positions of the Nelson Piquet Jr Trophy standings, outputted by afepf_viewer_program.py" %}
    {% "afepf4_npjt_drivers_p10-12.png", "Screenshot of the positions 10 to 12 of the Nelson Piquet Jr Trophy standings, outputted by afepf_viewer_program.py" %} 
    ...
    {% "afepf4_teams_p1-5.png", "Screenshot of the first 5 position of the Teams' Championship, outputted by afepf_viewer_program.py" %}
    {% "afepf4_teams_p6-10.png", "Screenshot of positions 6 to 10 of the Teams' Championship, outputted by afepf_viewer_program.py" %}
    ...
    {% "afepf4_manufacturers_p1-9.png", "Screenshot of the Manufacturers' Cup standings, outputted by afepf_viewer_program.py" %}
  </div>
</div>