        ...
        <div class="accordion" id="accordionObject">
            ...
            <h2 class="accordion-header" id="headingOne">
                ...
                <div class="accordion-body">
                    This is my review of the Nisekoi Volume 2. The chapters now are lot shorter and so the summaries will be smaller, as that was one of my main criticisms with my first review. I might go back and edit some of them to be smaller.
                </div>
                </div>
            </div>
            <div class="accordion-item">
