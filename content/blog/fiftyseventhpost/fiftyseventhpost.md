...
<div class="container fluid">
  ...
  <div class="row justify-content-center">
   ...
   {% "afepf6_drivers_p1-9.png", "Screenshot of the first 9 positions of the Drivers' Championship, outputted by afepf_viewer_program.py" %}
   {% "afepf6_drivers_p10-18.png", "Screenshot of the positions 10 to 18 of the Drivers' Championship, outputted by afepf_viewer_program.py" %}
   {% "afepf6_drivers_p19-27.png", "Screenshot of the positions 19 to 27 of the Drivers' Championship, outputted by afepf_viewer_program.py" %}
   {% "afepf6_drivers_p28.png",  "Screenshot of the position 28 of the Drivers' Championship, outputted by afepf_viewer_program.py" %}
   ...
   {% "afepf6_customer_drivers_p1-4.png", "Screenshot of the Customer Trophy for Drivers, outputted by afepf_viewer_program.py" %}
   ...
   {% "afepf6_npjt_drivers_p1-9.png", "Screenshot of the first 9 positions of the Nelson Piquet Jr Trophy, outputted by afepf_viewer_program.py" %}
   {% "afepf6_npjt_drivers_p10-11.png", "Screenshot of positions 10 and 11 of the Nelson Piquet Jr Trophy, outputted by afepf_viewer_program.py" %}
   ...
   {% "afepf6_teams_p1-9.png", "Screenshot of the first 9 positions of the Teams' Championship, outputted by afepf_viewer_program.py" %}
   {% "afepf6_teams_p10-12.png", "Screenshot of the positions 10 to 12 of the Teams' Championship, outputted by afepf_viewer_program.py" %}
   ...
   {% "afepf6_customer_teams_p1-2.png", "Screenshot of the Customer Teams' Championship, outputted by afepf_viewer_program.py" %}
   ...
   {% "afepf6_manufacturers_p1-6.png", "Screenshot of the first 6 positions of the Manufacturers' Cup standings, outputted by afepf_viewer_program.py" %}
   {% "afepf6_manufacturers_p7-10.png", "Screenshot of positions 7 to 10 of the Manufacturers' Cup standings, outputted by afepf_viewer_program.py" %}
  </div>
</div>